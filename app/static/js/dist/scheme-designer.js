...
(function (SchemeDesigner) {
    ...
    var SchemeObject = /** @class */ (function () {
         ...
         * @return boolean
         */
        SchemeObject.prototype.checkPointInObject = function (point, schemeDesigner, view) {
         ...
         * @param {Function} value
         */
        SchemeObject.prototype.setPointInObjectFunction = function (value) {
    ...
    var EventManager = /** @class */ (function () {
        ...
        EventManager.prototype.bindEvents = function () {
            ...
            this.scheme.getCanvas().addEventListener('touchend', function (e) {
                ...
                if (_this.lastTouchEndTime && now - _this.lastTouchEndTime <= _this.doubleTapDelay) {
                    e.preventDefault();
                }
                else {
                    _this.onMouseUp(e);
        ...
        EventManager.prototype.onDoubleClick = function (e) {
            var zoomManager = this.scheme.getZoomManager();
         ...
         * @param value
         */
        EventManager.prototype.setDoubleTapDelay = function (value) {
...
(function (SchemeDesigner) {
    ...
    var StorageManager = /** @class */ (function () {
        ...
        StorageManager.prototype.findObjectsByCoordinates = function (coordinates) {
            ...
            var normalizeCursorCoordinates = { x: x, y: y };
            ...
            for (var layerId in nodeObjectsByLayers) {
                ...
                for (var _i = 0, objects_1 = objects; _i < objects_1.length; _i++) {
                    ...
                    // check point in object
                    var normalizeCursorCoordinatesByObjectRect = {
...
(function (SchemeDesigner) {
    ...
    var ZoomManager = /** @class */ (function () {
         ...
         * Max zoom scale
         */
        ZoomManager.prototype.getMaxZoomScale = function () {
            var boundingRectDimensions = this.scheme.getStorageManager().getObjectsDimensions();
            var maxX = this.scheme.getWidth() * this.maxScale / boundingRectDimensions.width;
            var maxY = this.scheme.getHeight() * this.maxScale / boundingRectDimensions.height;
            return maxX > maxY ? maxX : maxY;
        };
        /**
         * Min zoom scale
         */
        ZoomManager.prototype.getMinZoomScale = function () {
            var boundingRectDimensions = this.scheme.getStorageManager().getObjectsDimensions();
            var minX = this.scheme.getWidth() * (1 - this.padding) / boundingRectDimensions.width;
            var minY = this.scheme.getHeight() * (1 - this.padding) / boundingRectDimensions.height;
        ...
        ZoomManager.prototype.zoomByFactor = function (factor) {
            ...
            var oldScale = this.scale;
            var requestedScale = oldScale * factor;
            var maxScale = this.getMaxZoomScale();
            var minScale = this.getMinZoomScale();
            var newScale = requestedScale;
         ...
         * @param value
         */
        ZoomManager.prototype.setClickZoomDelta = function (value) {
